...
im=cv2.imread('tree-pose.jpg')
im=cv2.resize(im,(400,480))
cap = cv2.VideoCapture(0) #cv2.CAP_V4L
#wave_obj = sa.WaveObject.from_wave_file("treez.wav")
#wave_obj.play()
        ...
        for j in range(len(keypoints)):
            ...
            if keypoints[j][1]:
                ...
                if (len(pnts)==3)  and (len(pntsssssss)== 3):
                    ...
                    #cv2.putText(src , str(angle)+','+str(angleeeeeee), (20, 60),  cv2.FONT_HERSHEY_SIMPLEX, 1, (102,200,111), 2,cv2.LINE_AA)
                ...
                if (len(pntsss)==3)  and (len(pntsssss)== 3):
                    ...
                    #cv2.putText(src , str(angleee)+','+str(angleeeee), (20, 60),  cv2.FONT_HERSHEY_SIMPLEX, 1, (102,200,111), 2,cv2.LINE_AA)
                ...
                if (len(pntssss)==3)  and (len(pntsssss)== 3):
                    ...
                    angleeeee = 150-(angle_between_points(pntsssss[0], pntsssss[1], pntsssss[2]))
                    #cv2.putText(src , str(angleeee)+','+str(angleeeee), (20, 60),  cv2.FONT_HERSHEY_SIMPLEX, 1, (102,200,111), 2,cv2.LINE_AA)
