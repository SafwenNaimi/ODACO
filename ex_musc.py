        ...
        for j in range(len(keypoints)):
            ...
            if keypoints[j][1]:
                ...
                if (j==6) or (j==8) or (j==10):
                    ...
                    bnts.append(((x * 640 ), (y * 480)))
                if (j==5) or (j==7) or (j==9):
                    cv2.circle(src, (x, y), 3, color, 4)
                    #cv2.putText(src , "%d" % int(keypoints[j][0]), (x + 5, y),  cv2.FONT_HERSHEY_SIMPLEX, 1, (0, 255, 255), 1)
                    pntss.append(((x * 640 ), (y * 480)))
                    bntss.append(((x * 640 ), (y * 480)))
                #print(len(pnts))
                ...
                if len(pnts)==3:
                    ...
                    #print(angle)
                    cv2.putText(src , str(round(angle)) , (20, 60),  cv2.FONT_HERSHEY_SIMPLEX, 1, (0, 255, 0), 2,cv2.LINE_AA)
                    if (80<(round(angle)) < 100): 
                    
                        #color=(0,255,0)  
                        #cv2.putText(src , "right elbow " , (20, 60),  cv2.FONT_HERSHEY_SIMPLEX, 1, (0, 255, 0), 2,cv2.LINE_AA)
                        print('ellouta ymin good')
                ...
                if len(pntss)==3:
                    ...
                    cv2.putText(src , str(round(anglee)) , (20, 100),  cv2.FONT_HERSHEY_SIMPLEX, 1, (0, 255, 0), 2,cv2.LINE_AA)
                    #print(anglee)
                    if (80<(round(anglee)) < 100):
                        #color=(0,255,0)  
                        #cv2.putText(src , "left elbow " , (20, 100),  cv2.FONT_HERSHEY_SIMPLEX, 1, (0, 255, 0), 2,cv2.LINE_AA)
                        print('ellouta ysar good')
